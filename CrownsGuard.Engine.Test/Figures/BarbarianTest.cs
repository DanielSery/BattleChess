...
public class BarbarianTest
{
    ...
    [Fact]
    public Task GetPossibleActions_PushLine_Left_WithBlocker_Verify()
    {
        const int src = 27; // d4
        const Figure barbarian = Figure.Barbarian | Figure.IsWhite;
    ...
    [Fact]
    public Task GetPossibleActions_PushLine_Up_ImmediatelyBlocked_Verify()
    {
        const int src = 27; // d4
        const Figure barbarian = Figure.Barbarian | Figure.IsWhite;
    ...
    [Fact]
    public Task GetPossibleActions_MixedDirections_Verify()
    {
        const int src = 27; // d4
        const Figure barbarian = Figure.Barbarian | Figure.IsWhite;
