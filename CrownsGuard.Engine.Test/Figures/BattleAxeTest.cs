...
public class BattleAxeTest
{
    ...
    [Fact]
    public Task GetPossibleActions_BlockedDiagonals_Verify()
    {
        const int src = 27; // d4
        const Figure axe = Figure.BattleAxe | Figure.IsWhite;
    ...
    [Fact]
    public Task ExecuteMove_UR_Destroys_Quadrant_Verify()
    {
        const int src = 27; // d4
        const Figure axe = Figure.BattleAxe | Figure.IsWhite;
    ...
    [Fact]
    public Task ExecuteMove_UL_Destroys_Quadrant_Verify()
    {
        const int src = 27; // d4
        const Figure axe = Figure.BattleAxe | Figure.IsWhite;
    ...
    [Fact]
    public Task ExecuteMove_DR_Destroys_Quadrant_Verify()
    {
        const int src = 27; // d4
        const Figure axe = Figure.BattleAxe | Figure.IsWhite;
    ...
    [Fact]
    public Task ExecuteMove_DL_Destroys_Quadrant_Verify()
    {
        const int src = 27; // d4
        const Figure axe = Figure.BattleAxe | Figure.IsWhite;
