        ...
        return Verify(new List<object>
        {
            ...
            TestUtils.RunGetActionsScenario(
                "White - Clear attack lines", b =>
                {
                    ...
                    var leftBack1 = src.GetWithOffset(PositionConstants.D1L1);
                    var leftBack2 = leftBack1 == -1 ? -1 : leftBack1.GetWithOffset(PositionConstants.D1L1);
                    var leftBack3 = leftBack2 == -1 ? -1 : leftBack2.GetWithOffset(PositionConstants.D1L1);
                    ...
                    var rightBack1 = src.GetWithOffset(PositionConstants.D1R1);
                    var rightBack2 = rightBack1 == -1 ? -1 : rightBack1.GetWithOffset(PositionConstants.D1R1);
                    var rightBack3 = rightBack2 == -1 ? -1 : rightBack2.GetWithOffset(PositionConstants.D1R1);
            ...
            TestUtils.RunGetActionsScenario(
                "Black - Clear attack lines", b =>
                {
                    ...
                    var leftForward1 = src.GetWithOffset(PositionConstants.U1L1);
                    var leftForward2 = leftForward1 == -1 ? -1 : leftForward1.GetWithOffset(PositionConstants.U1L1);
                    var leftForward3 = leftForward2 == -1 ? -1 : leftForward2.GetWithOffset(PositionConstants.U1L1);
                    ...
                    var rightForward1 = src.GetWithOffset(PositionConstants.U1R1);
                    var rightForward2 = rightForward1 == -1 ? -1 : rightForward1.GetWithOffset(PositionConstants.U1R1);
                    var rightForward3 = rightForward2 == -1 ? -1 : rightForward2.GetWithOffset(PositionConstants.U1R1);
