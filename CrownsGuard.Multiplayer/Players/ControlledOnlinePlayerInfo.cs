...
public class ControlledOnlinePlayerInfo : IOnlinePlayerInfo, IControlledPlayer
{
    public ControlledOnlinePlayerInfo(PlayerColor playerColor, string playerName, string? playerId, int? elo)
    {
