...
public interface IDisneyFigureGroup : IFigureType
{
    ...
    IDictionary<int, Uri> IFigureType.ImageUris => new Dictionary<int, Uri>
    {
        {
            1,
            new Uri($"pack://application:,,,/BattleChess3.DisneyFigures;component/Images/{GetType().Name}1.png",
                UriKind.Absolute)
        },
        {
            2,
            new Uri($"pack://application:,,,/BattleChess3.DisneyFigures;component/Images/{GetType().Name}2.png",
                UriKind.Absolute)
        }
    };
}