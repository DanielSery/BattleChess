...
public class SinglePawn : IDoubleChessFigureType
{
    ...
    public IEnumerable<FigureAction> GetPossibleActions(ITile unitTile, IBoard board)
    {
        ...
        else if (TryGetMergeAction(unitTile, board, new Position(0, 1), out var mergeAction1))
        {
        ...
        if (TryGetMoveAction(unitTile, board, new Position(0, 2), out var moveAction2))
        {
            yield return moveAction2;
        }
        else if (TryGetMergeAction(unitTile, board, new Position(0, 2), out var mergeAction2))
        {
